...
pub(super) fn pane_kind_to_config(kind: &PaneKind) -> PaneKindConfig {
    match kind {
        ...
        PaneKind::CompactWalletTracker(id) => PaneKindConfig::CompactWalletTracker { id: *id },
...
pub(super) fn pane_kind_from_config(kind: &PaneKindConfig) -> Option<PaneKind> {
    match kind {
        ...
        PaneKindConfig::CompactWalletTracker { id } => Some(PaneKind::CompactWalletTracker(*id)),
