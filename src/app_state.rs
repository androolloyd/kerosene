...
pub(crate) struct TradingTerminal {
    ...
    pub(crate) window_transparency_enabled: bool,
    pub(crate) window_background_blur_enabled: bool,
    pub(crate) window_background_opacity: f32,
    ...
    pub(crate) pane_dividers_enabled: bool,
