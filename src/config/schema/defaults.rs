...
use crate::config::{
    ...
    default_custom_themes, default_display_font_config, default_theme,
};
...
impl Default for KeroseneConfig {
    fn default() -> Self {
        Self {
            ...
            schwab_client_id: String::new().into(),
            schwab_client_secret: String::new().into(),
            ...
            hydromancer_realtime_position_pnl_enabled: false,
            ...
            combined_portfolio: CombinedPortfolioConfig::default(),
