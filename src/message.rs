...
pub(crate) enum Message {
    ...
    LiveWatchlistPresetSelected(LiveWatchlistId, config::WatchlistPresetId),
    LiveWatchlistCreatePreset(LiveWatchlistId),
    WatchlistPresetNameChanged(config::WatchlistPresetId, String),
    WatchlistPresetDelete(config::WatchlistPresetId),
    ...
    AgentToggleToolTrace(usize),
    AgentToggleReasoning(usize),
    AgentFollowUpSelected(AgentPrompt),
    AgentNewChat,
    AgentSelectSession(u64),
    AgentToggleSidebar,
    AgentProviderChanged(config::AssistantProvider),
    AgentLocalServerDetected(
        u64,
        Result<Option<crate::llama_cpp::LlamaCppServer>, String>,
    ),
    ...
    HyperliquidProxyInputChanged(SecretInput),
    AddHyperliquidProxy,
    RemoveHyperliquidProxy(usize),
    SetHyperliquidProxiesEnabled(bool),
    ...
    ThemeChanged(String),
    UiScaleChanged(f32),
    ToggleWindowTransparency(bool),
    ToggleWindowBackgroundBlur(bool),
    WindowBackgroundOpacityChanged(f32),
    ...
    SpaghettiWatchlistPresetSelected(SpaghettiChartId, config::WatchlistPresetId),
    SpaghettiClearWatchlistPreset(SpaghettiChartId),
    ...
    RemoteWalletDatabaseUrlChanged(SecretInput),
    SaveRemoteWalletDatabase,
    DisconnectRemoteWalletDatabase,
    RemoteWalletDatabaseSync,
    RemoteWalletDatabaseLoaded(
        u64,
