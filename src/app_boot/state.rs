...
impl TradingTerminal {
    pub(super) fn boot_state(parts: BootStateParts<'_>) -> Self {
        ...
        let mut state = Self {
            ...
            built_in_layout_state: crate::layout_update::BuiltInLayoutState::default(),
            ...
            pane_dividers_enabled: cfg.pane_dividers_enabled,
            ...
            ticker_tape_exchange_stats: None,
            ticker_tape_exchange_stats_loading: false,
            ticker_tape_exchange_stats_request_id: 0,
            ticker_tape_exchange_stats_last_fetch_ms: None,
            live_watchlists,
