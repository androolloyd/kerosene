...
pub(super) fn message_route(message: &Message) -> UpdateRoute {
    match message {
        ...
        | Message::ChartGradientContrastChanged(_)
        ...
        | Message::SpaghettiWatchlistPresetSelected(_, _)
        | Message::SpaghettiClearWatchlistPreset(_)
        ...
        | Message::ChartSpotAssetContextsRestFetched(_, _)
