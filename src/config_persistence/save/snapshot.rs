...
impl TradingTerminal {
    ...
    pub(super) fn config_snapshot(&self) -> config::KeroseneConfig {
        ...
        config::KeroseneConfig {
            ...
            canvases: layout_snapshot.canvases,
            ...
            hydromancer_realtime_position_pnl_enabled: self
            ...
            telegram_feed_onboarding_dismissed: self.telegram_feed.onboarding_dismissed,
